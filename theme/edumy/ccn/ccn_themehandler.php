...
// }
$extraclasses = array('ccn_no_hero', 'ccn_header_style_' . $headertype, 'ccn_footer_style_' . $footertype, 'ccn_blog_style_' . $blogstyle, 'ccn_course_list_style_' . $courseliststyle, 'ccn_breadcrumb_style_' . $breadcrumb_style, $user_status, $ccn_frontcheck, $headertype_settings_class, $dash_header_setting_class, $course_single_style_class);
