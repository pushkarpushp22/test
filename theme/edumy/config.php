...
$ccnSheetsTheme = array('bootstrap.min', 'jquery-ui.min', 'font-awesome.min', 'font-awesome-animation.min', 'line-awesome.min', 'nouislider.min', 'menu', 'ace-responsive-menu', 'megadropdown', 'bootstrap-select.min', 'simplebar.min', 'progressbar', 'ccn-flaticon', 'flaticon', 'animate', 'slider', 'magnific-popup', 'timecounter', 'jquery.fancybox.min', 'spectrum', 'cocoon', 'dashbord_navitaion', 'responsive', 'cocoon-mdl', 'cocoon-dashboard');
