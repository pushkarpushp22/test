                ...
                <div class="ui_kit_tab mt30">
                  ...
                  for ($i = 1; $i <= $data->slidesnumber; $i++) {
                    ...
                    $text .= '<li class="nav-item">
                                <a class="'.$ccnClass.'" id="'.$ccnTabLink.'-tab" data-toggle="tab" href="#'.$ccnTabLink.'" role="tab" aria-controls="'.$ccnTabLink.'" aria-selected="true">'.$data->$ccnTabTitle.'</a>
                              </li>';
                  }
                 $text .='
                    </ul>
                    ...
                    for ($i = 1; $i <= $data->slidesnumber; $i++) {
                      ...
                      $text .='<div class="'.$ccnBodyClass.'" id="'.$ccnTabLink.'" role="tabpanel" aria-labelledby="'.$ccnTabLink.'-tab">'.$data->$ccnTabBody['text'].'</div>';
                    }
              $text .='
                  </div>
                </div>
