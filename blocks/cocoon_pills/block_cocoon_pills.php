  ...
  <div class="hvr_img_box_container">
    ...
    <div class="overlay">
      <div class="details">
        ...
        <a data-ccn="slide_btn_text'.$i.'" href="'.format_text($data->$slide_btn_link, FORMAT_HTML, array('filter' => true)).'">'.format_text($data->$slide_btn_text, FORMAT_HTML, array('filter' => true)).' <span class="span flaticon-right-arrow-1"></span></a>
      </div>
    </div>
  </div>
</div>';
