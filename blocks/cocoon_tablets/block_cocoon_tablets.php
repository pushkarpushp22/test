                ...
                $this->content->text .='
                  ...
                  $this->content->text .='
                      ...
                      if(!empty($this->content->feature_1_title)){
      									$this->content->text .='<h4 data-ccn="feature_1_title">'.format_text($this->content->feature_1_title, FORMAT_HTML, array('filter' => true)).'</h4>';
                      }
                      if(!empty($this->content->feature_1_subtitle)){
      									$this->content->text .='<p data-ccn="feature_1_subtitle">'.format_text($this->content->feature_1_subtitle, FORMAT_HTML, array('filter' => true)).'</p>';
                      }
                      $this->content->text .='
      								</div>
      							</div>';
                  ...
                  $this->content->text .='
                      ...
                      if(!empty($this->content->feature_2_title)){
      									$this->content->text .='<h4 data-ccn="feature_2_title">'.format_text($this->content->feature_2_title, FORMAT_HTML, array('filter' => true)).'</h4>';
                      }
                      if(!empty($this->content->feature_2_subtitle)){
                        $this->content->text .='<p data-ccn="feature_2_subtitle">'.format_text($this->content->feature_2_subtitle, FORMAT_HTML, array('filter' => true)).'</p>';
                      }
                      $this->content->text .='
      								</div>
      							</div>';
                  ...
                  $this->content->text .='
                      ...
                      if(!empty($this->content->feature_3_title)){
      									$this->content->text .='<h4 data-ccn="feature_3_title">'.format_text($this->content->feature_3_title, FORMAT_HTML, array('filter' => true)).'</h4>';
                      }
                      if(!empty($this->content->feature_3_subtitle)){
      									$this->content->text .='<p data-ccn="feature_3_subtitle">'.format_text($this->content->feature_3_subtitle, FORMAT_HTML, array('filter' => true)).'</p>';
                      }
                      $this->content->text .='
      								</div>
      							</div>';
                  ...
                  $this->content->text .= '
                      ...
                      if(!empty($this->content->feature_3_title)){
      									$this->content->text .='
      									<h4 data-ccn="feature_3_title">'.format_text($this->content->feature_4_title, FORMAT_HTML, array('filter' => true)).'</h4>';
                      }
                      if(!empty($this->content->feature_3_subtitle)){
      									$this->content->text .='
